<template>
  <div>
    ...
    <div class="card flex justify-center">
      <Button label="Agregar Bodega" @click="visible = true" />
      ...
      >
        <template #header>
          <div class="custom-header">
            <span class="text-xl font-semibold">Crear Bodega</span>
          </div>
        </template>
            ...
            <div class="dialog-content">
               <div class="flex flex-column gap-2">
                    ...
                    <InputText id="name" v-model="storage.name" aria-describedby="username-help" class="p-inputtext-lg" />
                </div>
                <br>
                                <br>
